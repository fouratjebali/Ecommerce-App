...
export const fallbackStorefront: StorefrontHomepage = {
  hero: {
    eyebrow: 'Artisanat tunisien traceable',
    title: "La marketplace tunisienne ou chaque creation raconte son impact.",
    subtitle:
      'GreenCraft Tunisia rapproche les acheteurs attentifs et les artisans de Nabeul, Sousse, Tozeur et d ailleurs, autour de matieres revalorisees, durables et sourcées avec soin.',
  ...
  metrics: [
    {
      ...
      value: '64',
      detail: 'Ateliers verifies pour leur sourcing responsable et leur transparence.',
    },
    {
  ...
  categories: [
    ...
    },
    {
      ...
      impactHighlight:
        'Le score de durabilite valorise les pieces concues pour durer longtemps',
    },
  ],
  featuredProducts: [
    {
    ...
    },
    {
      ...
      imageHint: 'Lampe tissée aux lignes organiques',
    },
  ],
  artisans: [
    {
