...
const environmentSchema = z.object({
  ...
  VISUAL_SEARCH_VECTOR_DIMENSIONS: z.coerce.number().int().positive().default(192),
  VISUAL_SEARCH_DEFAULT_LIMIT: z.coerce.number().int().positive().max(24).default(8),
  VISUAL_SEARCH_CACHE_TTL_MINUTES: z.coerce.number().int().positive().default(360),
